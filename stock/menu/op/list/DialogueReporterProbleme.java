...
public class DialogueReporterProbleme extends javax.swing.JDialog {
    ...
    private final FenetreOPListeiPads fenMere;
    private Ipad iPad;
    ...
    public DialogueReporterProbleme(java.awt.Frame parent, boolean modal) {
        ...
        this.fenMere = (FenetreOPListeiPads) parent;
        this.rbManquant.setVisible(false);
        this.rbFonctionnel.setVisible(false);
    ...
    private void btnOKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOKMouseClicked
        if (this.btnOK.isEnabled())
        {
            ...
            String etatIpadBDD = SQL_function.getEtatIpad_Local(bdd.getlocal().getstatement(), this.iPad.getDbNum());
            
            //Si l'etat est modifie dans la fenetre => modif dans la BDD
            if(!this.etatIpad.equalsIgnoreCase(etatIpadBDD))
            {
                SQL_function.changeEtatIpad_Local(bdd.getlocal().getstatement(), this.iPad.getDbNum(), etatIpadBDD, this.etatIpad, "entrepot");
            }
    ...
    private void txtRfidKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRfidKeyReleased
        ...
        if (this.txtRfid.getText().equals("")){
            ...
            this.rbFonctionnel.grabFocus();
                ...
                connexion_bdd bdd = new connexion_bdd();
                List<Ipad> listIpad = SQL_function.getListIpadsBDD_Local(bdd.getlocal().getstatement());
                if(!listIpad.isEmpty())
                {
                    ...
                    if(rfidTrouve)
                    {
                        ...
                        this.etatIpad = SQL_function.getEtatIpad_Local(bdd.getlocal().getstatement(), this.iPad.getDbNum());
                        ...
                        {
                            this.rbFonctionnel.setVisible(true);
