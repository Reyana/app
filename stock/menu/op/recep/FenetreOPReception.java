 ...
 * @author Magency
 */
public class FenetreOPReception extends javax.swing.JFrame {
     ...
     */
    public FenetreOPReception(OP op) {
        initComponents();
    ...
    public FenetreOPReception(OP op, int longueur, int largeur) {
        this(op);
    ...
    private void initComponents() {
        ...
        tablOPReception = new javax.swing.JTable();
        ...
        tablOPReception.setAutoCreateRowSorter(true);
        tablOPReception.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tablOPReception.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Nom conteneur", "iPads venant de l'entrepôt", "iPads scannés"
            }
        ) {
        ...
        tablOPReception.setGridColor(new java.awt.Color(102, 102, 102));
        tablOPReception.setRowHeight(30);
        tablOPReception.setSelectionBackground(new java.awt.Color(153, 204, 255));
        tablOPReception.setSelectionForeground(new java.awt.Color(0, 0, 0));
        tablOPReception.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablOPReceptionMousePressed(evt);
            }
        });
        jScrollPane.setViewportView(tablOPReception);
    ...
    private void btnRetourMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRetourMouseClicked
        FenetreMenuOP fMenuOP = new FenetreMenuOP(this.op, 
    ...
    private void btnScanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnScanMouseClicked
        ...
        {
            Conteneur selectedConteneur = this.op.getListConteneur().get(this.tablOPReception.convertRowIndexToModel(this.tablOPReception.getSelectedRow()));
            DialogueDecharger dDecharger = new DialogueDecharger(this, true, 
                                            selectedConteneur, 
                                            this.getWidth(), this.getHeight(), this.listIpadsOP );
    ...
    private void btnValiderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnValiderMouseClicked
        ...
        for(Ipad iPad : this.listIpadsOP)
        {
            ...
            System.out.println("id = " + iPad.getDbNum());
        }
        
        if(!listIdIpadsOP.isEmpty())
        {
            retireIpadsConteneurs(this.listIpadsOP);
            SQL_function.receptionOPvalidee(listIdIpadsOP, this.op.getNomOP());
            
            // Retour dans la fenetre de menu de l'OP ares validation
            FenetreMenuOP fMenuOP = new FenetreMenuOP(this.op, 
                                                    this.getWidth(), this.getHeight());
            fMenuOP.setVisible(true);
            this.dispose();
    ...
    private void tablOPReceptionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablOPReceptionMousePressed
        this.btnScan.setEnabled(true);
    }//GEN-LAST:event_tablOPReceptionMousePressed
    ...
    private void afficheConteneur(Conteneur conteneur)
    {
        ...
        DefaultTableModel dtm = (DefaultTableModel)this.tablOPReception.getModel();
     ...
     */
    public void refreshNbScansConteneur(Conteneur conteneurScanne, int nbScans)
    {
        ...
        if(trouve)
        {
            ...
            Integer oldNbScans = (Integer)dtm.getValueAt(
                    this.tablOPReception.convertRowIndexToModel(this.tablOPReception.getSelectedRow()), 2);
            if(oldNbScans == null)
                newNbScans = nbScans;
            else
    ...
    private void retireIpadsConteneurs(List<Ipad> listIpadScannes)
    {
        for(Ipad iPadScanne : listIpadScannes)
        {
            for(Conteneur conteneur : this.op.getListConteneur())
            {
                if(conteneur.getListIpad().contains(iPadScanne))
                {
                    conteneur.retirerIpad(iPadScanne);
                }
            }
        }
    }
    ...
    private javax.swing.JTable tablOPReception;
