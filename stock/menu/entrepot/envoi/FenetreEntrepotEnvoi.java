 ...
 * @author Magency
 */
public class FenetreEntrepotEnvoi extends javax.swing.JFrame {

    private OP op ;
    private List<Conteneur> conteneur_baseServer = new ArrayList<Conteneur>();

    /**
     * Creates new form FenetreEntrepotReception
     */
    
    public FenetreEntrepotEnvoi(OP op) {
        this.op = op;
        initComponents();
        this.op = op;
    ...
    public FenetreEntrepotEnvoi(OP op, int longueur, int largeur) {
        this(op);
    ...
    private void initComponents() {
        ...
        tablEntrepotEnvoi = new javax.swing.JTable();
        ...
        panelBoutonsSO = new javax.swing.JPanel();
        ...
        labelNomFenetre.setText("Envoi vers ");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        tablEntrepotEnvoi.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tablEntrepotEnvoi.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tablEntrepotEnvoi.setAutoCreateRowSorter(true);
        tablEntrepotEnvoi.setGridColor(new java.awt.Color(102, 102, 102));
        tablEntrepotEnvoi.setRowHeight(30);
        tablEntrepotEnvoi.setSelectionBackground(new java.awt.Color(153, 204, 255));
        tablEntrepotEnvoi.setSelectionForeground(new java.awt.Color(0, 0, 0));
        tablEntrepotEnvoi.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tablEntrepotEnvoi.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tablEntrepotEnvoiMousePressed(evt);
            }
        });
        jScrollPane.setViewportView(tablEntrepotEnvoi);
        ...
        btnCharger.setDefaultCapable(false);
        ...
        btnListe.setDefaultCapable(false);
        ...
        btnValider.setDefaultCapable(false);
        ...
        panelBoutonsSO.setLayout(new java.awt.GridBagLayout());

        btnAjout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/images/Bouton +.PNG"))); // NOI18N
        btnAjout.setToolTipText("Ajout d'un nouveau conteneur dans la base de données");
        btnAjout.setBorderPainted(false);
        btnAjout.setContentAreaFilled(false);
        btnAjout.setMaximumSize(new java.awt.Dimension(32, 32));
        btnAjout.setMinimumSize(new java.awt.Dimension(16, 16));
        btnAjout.setPreferredSize(new java.awt.Dimension(32, 32));
        ...
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        panelBoutonsSO.add(btnAjout, gridBagConstraints);

        btnSupprimer.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/images/Bouton X.PNG"))); // NOI18N
        btnSupprimer.setToolTipText("Suppression du conteneur selectionné de la base de données");
        btnSupprimer.setBorderPainted(false);
        btnSupprimer.setContentAreaFilled(false);
        btnSupprimer.setMaximumSize(new java.awt.Dimension(32, 32));
        btnSupprimer.setMinimumSize(new java.awt.Dimension(16, 16));
        ...
        gridBagConstraints.gridx = 1;
        gridBagConstraints.gridy = 0;
        panelBoutonsSO.add(btnSupprimer, gridBagConstraints);

        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.gridwidth = 2;
        getContentPane().add(panelBoutonsSO, gridBagConstraints);
    ...
    private void btnChargerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnChargerMouseClicked
       String nameSelectedConteneur = "";
        ...
        this.conteneur_baseServer = SQL_function.getListConteneursLibresOp(bdd.getserver().getstatement(), this.op.getNomOP());
        bdd.closeall();
        if (conteneur_baseServer.isEmpty()) 
        {
            // Dialogue indiquant que il n'y a rien dans la box
            String avert = "Tous les conteneurs sont utilisés";
            DialogueAvertissement warning = new DialogueAvertissement(this, true, avert);
            warning.setVisible(true);
        }
        else
        {
            int selectedRowView = this.tablEntrepotEnvoi.getSelectedRow();
            if(selectedRowView > -1)
            {
                int selectedRow = this.tablEntrepotEnvoi.convertRowIndexToModel(selectedRowView);
                nameSelectedConteneur = this.op.getListConteneur().get(selectedRow).getName();
            }
            
            DialogueEntrepotCharger fCharger = new DialogueEntrepotCharger(this, true, 
                                                    this.getWidth(), this.getHeight(), 
                                                    op, conteneur_baseServer, nameSelectedConteneur);
    ...
    private void btnListeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnListeMouseClicked
        ...
        {
            int selectedRow = this.tablEntrepotEnvoi.convertRowIndexToModel(this.tablEntrepotEnvoi.getSelectedRow());
    ...
    private void tablEntrepotEnvoiMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablEntrepotEnvoiMousePressed
        this.btnListe.setEnabled(true);
        this.btnRetirerChariotOP.setEnabled(true);
    }//GEN-LAST:event_tablEntrepotEnvoiMousePressed

    private void btnValiderMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnValiderMouseClicked
        boolean ConteneurVide = false;
        if(!this.op.getListConteneur().isEmpty()){
            for (Conteneur C: this.op.getListConteneur()){
                if (C.getNbIpad()==0)
                    ConteneurVide = true; 
            }
            if(!ConteneurVide){
                connexion_bdd bdd = new connexion_bdd();
                DialogueChoixImport dialChoixImport = new DialogueChoixImport(this, true, 
                                    this.op, SQL_function.miseajourbase(op), "entrepotEnvoi");
                dialChoixImport.setVisible(true);

                /*DialogueRechercheZip dzip = new DialogueRechercheZip("entrepotEnvoi",this, true, this.getWidth(), this.getHeight(),SQL_function.miseajourbase(op),op);
                dzip.setVisible(true);*/ 
            }else{
                DialogueAvertissement warning = new DialogueAvertissement(this,true,"Conteneur vide présent");
                warning.setVisible(true);
            }
        }else{
            DialogueAvertissement warning = new DialogueAvertissement(this,true, "OP vide");
                warning.setVisible(true);
    ...
    private void btnAjoutMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAjoutMouseClicked
        DialogueAjoutConteneur fNewConteneur = new DialogueAjoutConteneur(this, true, this.getWidth(), this.getHeight());
        fNewConteneur.setVisible(true);
    ...
    private void btnSupprimerMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSupprimerMouseClicked
        DialogueSupprimerConteneur fSupConteneur = new DialogueSupprimerConteneur(this, true, this.getWidth(), this.getHeight());
        fSupConteneur.setVisible(true);
    ...
    private void btnRetirerChariotOPMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRetirerChariotOPMouseClicked
        ...
        {
            DefaultTableModel dtm = (DefaultTableModel)this.tablEntrepotEnvoi.getModel(); 
            int selectedRow = this.tablEntrepotEnvoi.convertRowIndexToModel(this.tablEntrepotEnvoi.getSelectedRow());
            Conteneur selectedConteneur = this.op.getListConteneur().get(selectedRow);
            ...
            // ne pas faire la modif directe sur la base dangereux seul envoi modifie la base
            //Si l'op a deja ete envoyee : retrait de la table OPE_CONTENEURS de la BDD
           // SQL_function.retireConteneurOP(selectedConteneur.getName());
    ...
    public void retirerIpadSelection(Ipad iPad)
    {
        ...
        this.op.getListConteneur().get(this.tablEntrepotEnvoi.getSelectedRow()).retirerIpad(iPad);
        // MAJ de l'affichage du nb d'iPad dans la JTable
        Integer oldNb = (Integer)this.tablEntrepotEnvoi.getValueAt(this.tablEntrepotEnvoi.getSelectedRow(), 1); 
        this.tablEntrepotEnvoi.setValueAt( oldNb - 1, this.tablEntrepotEnvoi.getSelectedRow(), 1);
    }
    public void retirerServeurSelection(Serveur sErveur)
    {
        // Retire de la liste de l'op
        this.op.getListConteneur().get(this.tablEntrepotEnvoi.getSelectedRow()).retirerServeur(sErveur);
        // MAJ de l'affichage du nb d'iPad dans la JTable
        Integer oldNb = (Integer)this.tablEntrepotEnvoi.getValueAt(this.tablEntrepotEnvoi.getSelectedRow(), 1); 
        this.tablEntrepotEnvoi.setValueAt( oldNb - 1, this.tablEntrepotEnvoi.getSelectedRow(), 1);
    }
    ...
    private void afficheConteneur(Conteneur conteneur)
    {
        ...
        if(this.op.getconfenv() ==1)
        {
            row.add(this.op.getStringDateDebut());
        }
    ...
    private javax.swing.JPanel panelBoutonsSO;
    private javax.swing.JPanel panelTexte;
    private javax.swing.JPanel panelTitre;
    private javax.swing.JTable tablEntrepotEnvoi;
