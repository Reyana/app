 ...
 * @author Magency
 */
public class DialogueModifIpad extends javax.swing.JDialog {
     ...
     */
    public DialogueModifIpad(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DialogueModifIpad(java.awt.Frame parent, boolean modal, int longueur, int largeur) {
        this(parent, modal);
    ...
    private void initComponents() {
        ...
        labelNomFenetre.setText("Modifier un iPad");
        ...
        labelRfid.setText("Scannez l'iPad a modifier :");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
    ...
    private void btnOKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOKMouseClicked
        ...
        if (this.btnOK.isEnabled()) {
            // Modification de l'iPad selectionne dans la BDD
            ...
            oldonnee = "code_rfid+" + iPad.getRfid() + "+";
            if (!etiquette.equals("")) {
                if (!iPad.getEtiquette().equals(etiquette)) {
                    //this.iPad.se(this.txtSN.getText());
            ...
            if ((iPad.getDateAchat() == null) && ((dateAchat == null))) {
                test = 0;
            } else {
                if (!(dateAchat == null)) {
                    if (iPad.getDateAchat() == null) {
                        System.out.println("ok1");
                        donnee = formatDate(donnee, dateAchat, "date_achat+", test);
                        test = 2;
                    } else {
                        if (!iPad.getDateAchat().equals(dateAchat)) {
            ...
            int garantie;
           if (!this.txtDureeGarantie.getText().equals("")&&!iPad.
            ...
            InstructionSql modif_ipad = new InstructionSql();
            modif_ipad.Update_Ipad(donnee, oldonnee);
            
            // MAJ de l'affichage des iPads dans la JTable
        ...
        if (this.txtRfid.getText().equals("")){
            ...
            this.txtUdid.grabFocus();
                ...
                //recherche dans la base de l'ipad
                    ...
                    if(!listIpad.isEmpty())
                    {
                        // On recherche dans la liste l'iPad avec le code RFID entre dans la fenetre
