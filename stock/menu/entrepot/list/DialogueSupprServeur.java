 ...
 * @author Magency
 */
public class DialogueSupprServeur extends javax.swing.JDialog {
     ...
     */
    public DialogueSupprServeur(java.awt.Frame parent, boolean modal, int id) {
        super(parent, modal);
        initComponents();
        ...
        this.id = id;
        afficheChampsServeur();
    }

    public DialogueSupprServeur(java.awt.Frame parent, boolean modal, int longueur, int largeur, int id) {
    ...
    private void initComponents() {
        ...
        labelNomFenetre.setText("Supprimer un Serveur");
        ...
        jLabel7.setText("Êtes-vous sûrs de vouloir retirer cet Serveur");
    ...
    private void btnOKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOKMouseClicked
        // Suppression dans la BDD de l'Serveur selectionne
        connexion_bdd bdd = new connexion_bdd();
        SQL_function.removeServeurBDD(bdd.getserver().getstatement(), this.id);
        bdd.closeall();
     ...
     * u Serveurpasse en arametre
     *
     * @param Serveur {@link Serveur} dont les informations sont recuperees
     */
    private void afficheChampsServeur()
    {
        int i = 0;
        //Charger la liste de Serveur depuis la BDD
        connexion_bdd bdd = new connexion_bdd();
        Serveur sErveurBDD = SQL_function.getServeurFromId_BDD(bdd.getserver().getstatement(), this.id);          
        if(sErveurBDD != null)            
        {           
            this.txtNumBDD.setText(String.valueOf(sErveurBDD.getDbNum()));
            this.txtSN.setText(sErveurBDD.getNumSerie());
            this.txtUdid.setText(sErveurBDD.getUdid());
            this.txtEtiquette.setText(sErveurBDD.getEtiquette());
            this.txtDateAchat.setText(sErveurBDD.getStringDateAchat());
            this.txtDureeGarantie.setText(sErveurBDD.getDureeGarantie());
        }
    }
