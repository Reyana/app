 ...
 * @author Magency
 */
public class DialogueAjoutServeur extends javax.swing.JDialog {
     ...
     */
    public DialogueAjoutServeur(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public DialogueAjoutServeur(java.awt.Frame parent, boolean modal, int longueur, int largeur) {
        this(parent, modal);
    ...
    private void initComponents() {
        ...
        labelNomFenetre.setText("Ajout d'un Serveur");
    ...
    private void btnOKMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnOKMouseClicked
        if (this.btnOK.isEnabled()) {
            ...
            if (!numSerie.equals("") && !udid.equals("") && !rfid.equals("")) {
                Serveur newServeur = new Serveur(numSerie, udid, rfid);
                // Ajout de l'etiquette si il y en a une
                if (!numSerie.equals("")) {
                    newServeur.setEtiquette(etiquette);
                }

                //Ajout de la date d'achat s'il y en a une correcte
                if (dateAchat != null) {
                    newServeur.setDateAchat(dateAchat);
                }

                // Ajout de la durée de garantie s'il y en a une, 1 an par defaut
                if (!dureeGarantie.equals("")) {
                    newServeur.setDureeGarantie(dureeGarantie);
                } else {
                    newServeur.setDureeGarantie("1 an");
                }
                ...
                // Ajout du nouveau Serveur dans la BDD
                System.out.println(garantie);
                InstructionSql ajout_serveur = new InstructionSql();
                ajout_serveur.Ajout_Serveur(donnee);
                //FenetreEntrepotListesErveurs listeServeur = new FenetreEntrepotListesErveurs();
                //listeServeur.reinitAffichage();
                //Affichage du nouvel sErveur dans la JTable
                this.fenMere.addServeur(newServeur);
