 ...
 * @author Magency
 */
public class DialogueEntrepotDecharger extends javax.swing.JDialog {
    private FenetreEntrepotReception fenMere;
     ...
     */
    public DialogueEntrepotDecharger(java.awt.Frame parent, boolean modal, Conteneur conteneur,List<Ipad> listIpadsOP) {
        super(parent, modal);
        initComponents();
        ...
        this.fenMere = (FenetreEntrepotReception)parent;
        
        // Recupere une copie du conteneur
    ...
    public DialogueEntrepotDecharger(java.awt.Frame parent, boolean modal, Conteneur conteneur, 
 ...
 int nbScans = 0;
        ...
        this.fenMere.dechargeConteneur(this.conteneur, nbScans);
